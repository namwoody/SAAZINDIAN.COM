...
echo $widgetNL->widget(array('form' => 1, 'form_type' => 'php'));
 ...
 <div id="header">
  ...
  <div class="container">
  <div class="row">
    <div class="col-lg-3 col-lg-push-9 col-md-3 col-md-push-9 col-sm-3 col-sm-push-9 col-xs-3 col-xs-push-7 " style="position:absolute; margin-top:14px;">
    	
    	<div class="btn-group">
    		
    	<button id="reservation" data-toggle="dropdown">Order online  <span class="caret"></span></button>
    	<ul class="dropdown-menu" role="menu">
    		<li>  <a href="https://www.grubhub.com/nyc/saaz-indian-restaurant-country-road-39/" target="_top">Grubhub</a></li>
    		<li class="divider"></li>
    		<li>  <a href="http://eat24hrs.com/restaurants/order/menu.php?id=33624" target="_top">Eat24</a></li>
